...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_epochs', type=int, help="FedOpt: The number of local epochs until we synchronize the model.", default=1)
    parser.add_argument('--max_epochs', type=int, help="FDA-Opt: The number of local epochs until we forcibly synchronize the model.", default=-1)
